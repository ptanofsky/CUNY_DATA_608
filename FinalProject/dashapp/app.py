...
tab1 = html.Div([
    html.Div([
        # Intro
        html.Div([
            html.H3(children='Bivariate choropleth map of Austin')
        ]),
        # Dropdown 1
        html.Div([
            html.P("Select two census statistics from 2017 to visualize the relationship across 45 zip codes in Austin (Color legend to the right)"),
    ...
    html.Div([
        html.P("Select categories to view locations on the map (Click markers for more info):"),
        dcc.Checklist(
            id='markers-tab1',
    ...
    html.Div([
        ...
        html.Div([
            html.H3("Scatterplot of Selected Statistics Above"),
            dcc.Graph(
                id='stat-1-graph'
            )
    ...
    html.Div([
        ...
        style={'width': '100%', 'display': 'inline-block', 'padding': '100px', 'margin': 'auto'}),
    ],
    style={'width': '100%', 'display': 'inline-block', 'textAlign': 'center'}),
    # Data sources
    html.Div([
        html.H6("Data sources:"),
        html.A(children="Census Statistics", href="https://www.austintexas.gov/page/demographic-data"),
        html.Br(),
        html.A(children="Golf Courses", href="https://data.austintexas.gov/Recreation-and-Culture/Golf-Courses-in-Austin/dtkn-v97q"),
        html.Br(),
        html.A(children="Computer Labs", href="https://data.austintexas.gov/dataset/Public-Computer-Labs/s6uc-6djk"),
        html.Br(),
        html.A(children="Car Charging Stations", href="https://data.austintexas.gov/Utilities-and-City-Services/Plug-In-EVerywhere-Charging-Station-Network/k5hp-eece"),
        html.Br(),
        html.A(children="Housing Listings", href="https://data.austintexas.gov/Housing-and-Real-Estate/Affordable-Housing-Listing/ngxp-99y3"),
        html.Br(),
        html.A(children="Officer Shootings", href="https://data.austintexas.gov/Public-Safety/Officer-Involved-Shootings-2008-17-Incidents/uzqv-9uza")
    ]),
])
...
tab2 = html.Div([
    html.Div([
        html.H3(children='Austin: 2011-2018'),
        html.P(
            "Select census statistic and year to visualize socioeconomic change during the 2010s decade across 45 zip codes in Austin"),
        html.Div([
    ...
    html.Div([
        html.P("Select categories to view 2017 locations on the map (Click markers for more info):"),
        dcc.Checklist(
            id='markers',
            options=[{'value': x, 'label': x}
                     for x in markers_options],
    ...
    html.Div([
        html.H6("Data sources:"),
        html.A(children="Census Statistics", href="https://www.census.gov/data/developers/data-sets/acs-5year.2011.html"),
        html.Br(),
        html.A(children="Golf Courses",
               href="https://data.austintexas.gov/Recreation-and-Culture/Golf-Courses-in-Austin/dtkn-v97q"),
        html.Br(),
        html.A(children="Computer Labs", href="https://data.austintexas.gov/dataset/Public-Computer-Labs/s6uc-6djk"),
        html.Br(),
        html.A(children="Car Charging Stations",
               href="https://data.austintexas.gov/Utilities-and-City-Services/Plug-In-EVerywhere-Charging-Station-Network/k5hp-eece"),
        html.Br(),
        html.A(children="Housing Listings",
               href="https://data.austintexas.gov/Housing-and-Real-Estate/Affordable-Housing-Listing/ngxp-99y3"),
        html.Br(),
        html.A(children="Officer Shootings",
               href="https://data.austintexas.gov/Public-Safety/Officer-Involved-Shootings-2008-17-Incidents/uzqv-9uza")
    ]),
])
...
app.layout = html.Div([
    ...
    dcc.Tabs(id="tabs-example", value='tab-1-value', children=[
        dcc.Tab(id="tab-1", label='Austin: 2017', value='tab-1-value'),
