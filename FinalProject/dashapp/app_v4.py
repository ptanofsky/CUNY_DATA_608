...
#TODO Remove zip code itself from the drop down
...
def build_atx_map(inp1, inp2):
    ...
    #TODO Remove this choropleth when ready
    '''
...
app.layout = html.Div([
    ...
    dcc.Tabs(id="tabs-example", value='tab-1-value', children=[
        dcc.Tab(id="tab-1", label='Tab One', value='tab-1-value'),
        dcc.Tab(id="tab-2", label='Tab Two', value='tab-2-value'),
    ]),
